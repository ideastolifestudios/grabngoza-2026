          ...
          <div className="flex items-center justify-between h-16 lg:h-[84px]">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="hidden lg:flex text-white hover:text-brand-accent transition-colors duration-200 cursor-pointer"
              >
                <MapPin size={18} />
              </button>
              <Link
                href="/account"
                aria-label="Account"
                className="hidden lg:flex text-white hover:text-brand-accent transition-colors duration-200"
              >
                <User size={18} />
              </Link>
              <button
              ...
              <Link
                ...
                className="text-white hover:text-brand-accent transition-colors duration-200 relative"
              >
                <ShoppingBag size={20} />
                {cartCount > 0 && (
              ...
              <button
                ...
                className="lg:hidden text-white hover:text-brand-accent transition-colors duration-200 cursor-pointer ml-1"
              >
                <Menu size={22} />
              </button>
            </div>
